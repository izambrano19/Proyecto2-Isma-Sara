...
<div class="field" id="searchform">
  <input class="inputs" id="busqueda" name="busqueda" type="text" placeholder="Buscar" value="<?php echo $busqueda; ?>"/>
...
<?php
  ...
  $sql = mysqli_query($conexion, "SELECT * FROM tusuario 
  WHERE NombreUsuario LIKE '%$busqueda%'
  ORDER BY NombreUsuario ASC LIMIT $desde,$por_pagina 
  ");
